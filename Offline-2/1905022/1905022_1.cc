...
string datFileName = "staticNetwork";
...
main(int argc, char* argv[])
{
    ...
    ofstream throughput1 (fileName1, std::ios::out | std::ios::app);
    ofstream packetRatio1 (fileName2, std::ios::out | std::ios::app);
    ...
    channelSenders.AddPropagationLoss("ns3::RangePropagationLossModel","MaxRange", DoubleValue (txRange*covArea));
    // phySenders.Set("DataRate", DataRateValue(10000000));
    ...
    mobility.SetPositionAllocator ("ns3::GridPositionAllocator",
                                 ...
                                 "DeltaY", DoubleValue (2.0), //error with changing deltax ,deltay
 ...
 //   cout<<"chk "<<receivedPackets<<" "<<sentPackets<<endl;
    ...
    if(parametrized==1)
    {
        throughput1<<totalNodes<<" "<<throughput<<endl;
        packetRatio1<<totalNodes<<" "<<ratio<<endl;
    }
    else if(parametrized==2)
    {
        throughput1<<numFlow<<" "<<throughput<<endl;
        packetRatio1<<numFlow<<" "<<ratio<<endl;
    }

    else if(parametrized==3)
    {
        throughput1<<packetPerSecond<<" "<<throughput<<endl;
        packetRatio1<<packetPerSecond<<" "<<ratio<<endl;
    }

    else if(parametrized==4)
    {
        throughput1<<covArea<<" "<<throughput<<endl;
        packetRatio1<<covArea<<" "<<ratio<<endl;
    }
