...
for p in {1..4}; do
    ...
    if [ $p = 1 ] ;then
        pngFile1="scratch/ThroughputVsNodes2.png"
        pngFile2="scratch/PacketRatioVsNodes2.png"
        ...
        for i in $nodeArray; do
            ...
            ./ns3 run "$file $i $numFlow $packetPerSec $speed $p $datFile1 $datFile2" 
...
EOFMarker
    ...
    rm $datFile2
        ...
        pngFile1="scratch/ThroughputVsFlow2.png"
        pngFile2="scratch/PacketRatioVsFlow2.png"
        ...
        for i in $flowArray; do
            ...
            ./ns3 run "$file $totalNodes $i $packetPerSec $speed $p $datFile1 $datFile2"
...
EOFMarker
    ...
    rm $datFile2
        ...
        pngFile1="scratch/ThroughputVsPacket2.png"
        pngFile2="scratch/PacketRatioVsPacket2.png"
        ...
        for i in $packetArray; do
            ...
            ./ns3 run "$file $totalNodes $numFlow $i $speed $p $datFile1 $datFile2"
...
EOFMarker
    ...
    rm $datFile2
        ...
        pngFile1="scratch/ThroughputVsSpeed2.png"
        pngFile2="scratch/PacketRatioVsSpeed2.png"
        title1="Throughput vs Speed"
        title2="Packet Ratio vs Speed"
        touch $datFile1
        touch $datFile2


        for i in $speedArray; do
            echo "Running simulation with speed = $i"
            ./ns3 run "$file $totalNodes $numFlow $packetPerSec $i $p $datFile1 $datFile2"
            echo "Simulation with speed = $i completed"
        done
